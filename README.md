...
Я решил вставлять данные сразу, наверняка в продакшене так нельзя, но я решил попробовать и поэтому в конце добавил INSERT, но столкнулся с проблемой, что шарды не успевали стартовать и данных не было, поэтому я запускаю 
